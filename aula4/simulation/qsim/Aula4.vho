...
-- Equation(s):
-- \Decodificador|Equal5~0_combout\ = (!\PC|DOUT\(0) & (\ROM1|memROM~1_combout\ & (!\PC|DOUT\(3) & !\PC|DOUT\(2))))
...
-- Equation(s):
-- \ROM1|memROM~7_combout\ = (!\PC|DOUT\(3) & ((!\PC|DOUT\(0) & (\PC|DOUT\(1))) # (\PC|DOUT\(0) & (!\PC|DOUT\(1) & !\PC|DOUT\(2)))))
...
-- Equation(s):
-- \ROM1|memROM~3_combout\ = ( !\PC|DOUT\(8) & ( \ROM1|memROM~7_combout\ & ( (!\PC|DOUT\(4) & (!\PC|DOUT\(5) & (!\PC|DOUT\(6) & !\PC|DOUT\(7)))) ) ) )
...
-- Equation(s):
-- \Decodificador|Equal5~2_combout\ = (!\PC|DOUT\(1) & (\ROM1|memROM~1_combout\ & (!\PC|DOUT\(3) & \PC|DOUT\(2))))
...
-- Equation(s):
-- \Decodificador|Equal5~1_combout\ = (\PC|DOUT\(0) & (\ROM1|memROM~1_combout\ & (!\PC|DOUT\(3) & !\PC|DOUT\(2))))
...
-- Equation(s):
-- \RAM1|ram~88_combout\ = ( !\ROM1|memROM~5_combout\ & ( (\PC|DOUT\(0) & (\Decodificador|Equal5~1_combout\ & !\ROM1|memROM~3_combout\)) ) )
...
PORT MAP (
	dataa => \PC|ALT_INV_DOUT\(0),
	datac => \Decodificador|ALT_INV_Equal5~1_combout\,
...
-- Equation(s):
-- \RAM1|ram~89_combout\ = ( !\ROM1|memROM~5_combout\ & ( (\PC|DOUT\(0) & (\Decodificador|Equal5~1_combout\ & \ROM1|memROM~3_combout\)) ) )
...
-- Equation(s):
-- \ULA1|Add0~1_sumout\ = SUM(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & ((\RAM1|ram~90_combout\))) # (\Decodificador|Equal5~0_combout\ & (\ROM1|memROM~3_combout\)))) ) + ( \REGA|DOUT\(0) ) + ( \ULA1|Add0~34_cout\ ))
-- \ULA1|Add0~2\ = CARRY(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & ((\RAM1|ram~90_combout\))) # (\Decodificador|Equal5~0_combout\ & (\ROM1|memROM~3_combout\)))) ) + ( \REGA|DOUT\(0) ) + ( \ULA1|Add0~34_cout\ ))
...
-- Equation(s):
-- \MUX1|saida_MUX[0]~0_combout\ = (!\Decodificador|Equal5~0_combout\ & (((!\ROM1|memROM~4_combout\ & \RAM1|ram~81_combout\)))) # (\Decodificador|Equal5~0_combout\ & (\ROM1|memROM~3_combout\))
...
-- Equation(s):
-- \Decodificador|saida~1_combout\ = ( \ROM1|memROM~2_combout\ & ( (\ROM1|memROM~1_combout\ & ((\PC|DOUT\(3)) # (\PC|DOUT\(2)))) ) ) # ( !\ROM1|memROM~2_combout\ & ( (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~0_combout\ $ (((\PC|DOUT\(3)) # (\PC|DOUT\(2)))))) 
-- ) )
...
-- Equation(s):
-- \ULA1|Add0~5_sumout\ = SUM(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & ((\RAM1|ram~91_combout\))) # (\Decodificador|Equal5~0_combout\ & (\ROM1|memROM~6_combout\)))) ) + ( \REGA|DOUT\(1) ) + ( \ULA1|Add0~2\ ))
-- \ULA1|Add0~6\ = CARRY(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & ((\RAM1|ram~91_combout\))) # (\Decodificador|Equal5~0_combout\ & (\ROM1|memROM~6_combout\)))) ) + ( \REGA|DOUT\(1) ) + ( \ULA1|Add0~2\ ))
...
-- Equation(s):
-- \MUX1|saida_MUX[1]~1_combout\ = ( \RAM1|ram~26_q\ & ( \Decodificador|Equal5~0_combout\ & ( (\ROM1|memROM~5_combout\ & \PC|DOUT\(1)) ) ) ) # ( !\RAM1|ram~26_q\ & ( \Decodificador|Equal5~0_combout\ & ( (\ROM1|memROM~5_combout\ & \PC|DOUT\(1)) ) ) ) # ( 
-- \RAM1|ram~26_q\ & ( !\Decodificador|Equal5~0_combout\ & ( (!\ROM1|memROM~5_combout\ & ((\RAM1|ram~18_q\) # (\ROM1|memROM~3_combout\))) ) ) ) # ( !\RAM1|ram~26_q\ & ( !\Decodificador|Equal5~0_combout\ & ( (!\ROM1|memROM~5_combout\ & 
-- (!\ROM1|memROM~3_combout\ & \RAM1|ram~18_q\)) ) ) )
...
-- Equation(s):
-- \ULA1|Add0~9_sumout\ = SUM(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & ((\RAM1|ram~92_combout\))) # (\Decodificador|Equal5~0_combout\ & (\ROM1|memROM~4_combout\)))) ) + ( \REGA|DOUT\(2) ) + ( \ULA1|Add0~6\ ))
-- \ULA1|Add0~10\ = CARRY(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & ((\RAM1|ram~92_combout\))) # (\Decodificador|Equal5~0_combout\ & (\ROM1|memROM~4_combout\)))) ) + ( \REGA|DOUT\(2) ) + ( \ULA1|Add0~6\ ))
...
-- Equation(s):
-- \MUX1|saida_MUX[2]~2_combout\ = (!\Decodificador|Equal5~0_combout\ & (!\ROM1|memROM~4_combout\ & \RAM1|ram~82_combout\)) # (\Decodificador|Equal5~0_combout\ & (\ROM1|memROM~4_combout\))
...
-- Equation(s):
-- \ULA1|Add0~13_sumout\ = SUM(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & \RAM1|ram~93_combout\))) ) + ( \REGA|DOUT\(3) ) + ( \ULA1|Add0~10\ ))
-- \ULA1|Add0~14\ = CARRY(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & \RAM1|ram~93_combout\))) ) + ( \REGA|DOUT\(3) ) + ( \ULA1|Add0~10\ ))
...
-- Equation(s):
-- \MUX1|saida_MUX[3]~3_combout\ = (!\Decodificador|Equal5~0_combout\ & (!\ROM1|memROM~4_combout\ & \RAM1|ram~83_combout\))
...
-- Equation(s):
-- \ULA1|Add0~17_sumout\ = SUM(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & \RAM1|ram~94_combout\))) ) + ( \REGA|DOUT\(4) ) + ( \ULA1|Add0~14\ ))
-- \ULA1|Add0~18\ = CARRY(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & \RAM1|ram~94_combout\))) ) + ( \REGA|DOUT\(4) ) + ( \ULA1|Add0~14\ ))
...
-- Equation(s):
-- \MUX1|saida_MUX[4]~4_combout\ = (!\Decodificador|Equal5~0_combout\ & (!\ROM1|memROM~4_combout\ & \RAM1|ram~84_combout\))
...
-- Equation(s):
-- \ULA1|Add0~21_sumout\ = SUM(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & \RAM1|ram~95_combout\))) ) + ( \REGA|DOUT\(5) ) + ( \ULA1|Add0~18\ ))
-- \ULA1|Add0~22\ = CARRY(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & \RAM1|ram~95_combout\))) ) + ( \REGA|DOUT\(5) ) + ( \ULA1|Add0~18\ ))
...
-- Equation(s):
-- \MUX1|saida_MUX[5]~5_combout\ = (!\Decodificador|Equal5~0_combout\ & (!\ROM1|memROM~4_combout\ & \RAM1|ram~85_combout\))
...
-- Equation(s):
-- \ULA1|Add0~25_sumout\ = SUM(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & \RAM1|ram~96_combout\))) ) + ( \REGA|DOUT\(6) ) + ( \ULA1|Add0~22\ ))
-- \ULA1|Add0~26\ = CARRY(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & \RAM1|ram~96_combout\))) ) + ( \REGA|DOUT\(6) ) + ( \ULA1|Add0~22\ ))
...
-- Equation(s):
-- \ULA1|Add0~29_sumout\ = SUM(( !\Decodificador|Equal5~2_combout\ $ (((!\Decodificador|Equal5~0_combout\ & \RAM1|ram~97_combout\))) ) + ( \REGA|DOUT\(7) ) + ( \ULA1|Add0~26\ ))
...
-- Equation(s):
-- \Decodificador|saida~0_combout\ = ( \ROM1|memROM~2_combout\ & ( (\ROM1|memROM~1_combout\ & ((\PC|DOUT\(3)) # (\PC|DOUT\(2)))) ) ) # ( !\ROM1|memROM~2_combout\ & ( (\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & ((\PC|DOUT\(3)) # (\PC|DOUT\(2))))) ) 
-- )
